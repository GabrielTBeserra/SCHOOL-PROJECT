...
namespace SCHOOL_PROJECT_INFRASTRUCTURE.Migrations
{
    ...
    [Migration("20220318205050_First")]
    partial class First
    {
            ...
            modelBuilder.Entity("AUTH_SERVICE_DOMAIN.Entities.Audit.LogEntity", b =>
                {
                    ...
                    b.Property<DateTime>("LogTime")
                        ...
                        .HasDefaultValue(new DateTime(2022, 3, 18, 17, 50, 50, 0, DateTimeKind.Local).AddTicks(6575))
            ...
            modelBuilder.Entity("SCHOOL_PROJECT_DOMAIN.Relationships.SchoolUser.SchoolUserRelationship", b =>
                {
                    ...
                    b.HasOne("AUTH_SERVICE_DOMAIN.Entities.User.UserEntity", "User")
                        .WithMany("Schools")
